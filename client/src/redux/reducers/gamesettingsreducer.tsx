...
const gameSettingsReducer: Reducer<GameSettings, GameSettingsAction> = ( state: GameSettings = {musicOn:false, musicVolume: 50, canContinue: false, offline: true}, action: GameSettingsAction): GameSettings => {
    switch(action.type) {
